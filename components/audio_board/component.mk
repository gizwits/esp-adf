...
COMPONENT_ADD_INCLUDEDIRS += ./atom_v1
COMPONENT_SRCDIRS += ./atom_v1
endif

ifdef CONFIG_AUDIO_BOARD_ATOM_V1_2
COMPONENT_ADD_INCLUDEDIRS += ./atom_v1_2
COMPONENT_SRCDIRS += ./atom_v1_2
endif

ifdef CONFIG_AUDIO_BOARD_XIAOZHI_S3
COMPONENT_ADD_INCLUDEDIRS += ./xiaozhi_s3
COMPONENT_SRCDIRS += ./xiaozhi_s3
endif

ifdef CONFIG_AUDIO_BOARD_TOYCORE_V1
COMPONENT_ADD_INCLUDEDIRS += ./toycore_v1
COMPONENT_SRCDIRS += ./toycore_v1
endif
ifdef CONFIG_AUDIO_BOARD_TOYCORE_DINGSHE
COMPONENT_ADD_INCLUDEDIRS += ./toycore_dingshe
COMPONENT_SRCDIRS += ./toycore_dingshe
endif